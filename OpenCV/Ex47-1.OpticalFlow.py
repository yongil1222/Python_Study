...
feature_param = dict(maxCorners=200, qualityLevel=0.01, minDistance=7, blockSize=7)
    ...
    def run(self):
        while True:
            ...
            if len(self.tracks) > 0:
                ...
                p0r, st, err = cv2.calcOpticalFlowPyrLK(img1, img0, p0, None, **lk_params)
            ...
            if self.frame_idx % self.detect_interval == 0 :
                ...
                p = cv2.goodFeaturesToTrack(frame_gray, mask=mask, **feature_param)
                if p is not None:
