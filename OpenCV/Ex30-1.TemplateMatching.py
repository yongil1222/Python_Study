...
def tmpMatching():
    img1 = cv2.imread('E:/Python_Study/OpenCV/images/model.jpg', cv2.IMREAD_GRAYSCALE)
    img2 = img1.copy()

    template = cv2.imread('E:/Python_Study/OpenCV/images/face.jpg', cv2.IMREAD_GRAYSCALE)
